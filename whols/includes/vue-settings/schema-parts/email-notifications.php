...
return ['email-notifications_route' => [
    ...
    'texts' => [
        ...
        'registration_notification' => __('Registration Notification', 'whols'),
        'quote_request' => __('Quote Request', 'whols'),
        'conversation' => __('Conversation', 'whols'),
        'registration_confirmation' => __('Registration Confirmation', 'whols'),
        'account_approval' => __('Account Approval', 'whols'),
        'account_rejection' => __('Account Rejection', 'whols')
    ],
    'sections' => [],
    'fields' => [
